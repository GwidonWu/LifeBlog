...
namespace BLL.Service.Interface
{
    public interface ICategoryService : IBaseService<Category,int>
    {
        ...
        /// <returns></returns>
        OperResult Add(Category category, CategoryGeneral general);
        ...
        /// <returns></returns>
        OperResult Add(Category category, CategoryPage page);
        ...
        /// <returns></returns>
        OperResult Add(Category category, CategoryLink link);
        ...
        /// <returns></returns>
        OperResult Update(Category category, CategoryGeneral general);
        ...
        /// <returns></returns>
        OperResult Update(Category category, CategoryPage page);
        ...
        /// <returns></returns>
        OperResult Update(Category category, CategoryLink link);
        ...
        /// <returns></returns>
        List<Category> FindList(int number, CategoryType? type, OrderParam[] orderParams);
